const ANUBIS_PUREZA_POSITIVA = [
  "Tu corazón se aligera ante la pluma de Maat.",
  "Has obrado con justicia, mortal.",
  "Los dioses observan tu rectitud.",
...
const ANUBIS_PUREZA_NEGATIVA = [
  ...
  "Has elegido el sendero del caos.",
